...
const TermsOfService = () => {
  ...
  return (
    <>
      <Navbar />
      <div className={`p-8 ${isDark ? 'text-white' : 'text-black'}`} style={pageStyles} data-theme={theme}>
        <h1 className="text-3xl font-bold mb-4">Terms of Service</h1>
        <p className="mb-4"><strong>Effective Date: 07/23/2024</strong></p>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-2">When posting events on our Site, you agree to adhere to the following guidelines:</h2>
        ...
        <h3 className="text-xl font-semibold mb-2">Event Relevance</h3>
        <ul className="list-disc list-inside mb-4">
        ...
        <h3 className="text-xl font-semibold mb-2">Respectful Behavior</h3>
        <ul className="list-disc list-inside mb-4">
