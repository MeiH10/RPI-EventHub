        ...
        <div className={`min-h-screen flex flex-col ${isDark ? 'bg-[#383838]' : 'bg-[#F4F1EA]'}`}>
            ...
            <div className="flex-1 pt-20 px-2 md:px-4">
                ...
                <div className="max-w-[1900px] mx-auto">
                    <h1 className="text-[75px] md:text-[85px] lg:text-[100px] font-bold text-center mt-[-20px] mb-[20px] md:mb-[0px] md:mt-[20px] lg:mt-[30px] tracking-wide font-sans text-[#D6001C]">Calendar</h1>
