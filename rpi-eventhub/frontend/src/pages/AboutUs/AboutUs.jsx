...
function AboutUs() {
  ...
  return (
    ...
    //   <Footer />
    // </div>
    <div className='flex flex-col min-h-screen max-w-screen h-full w-full p-20'>
      <div className='flex flex-row w-full justify-between'>
        <div>
          <h1 className='text-xl font-semibold'>Mission Statement</h1>
          <h1 className='text-xl'>EventHub is dedicated to connecting the students of RPI with events happening all over campus. Through this website, we hope to foster greater community, connection, and collaboration throughout the campus. Our hope is for RPI students and staff to be able to effortlessly create, advertise, and explore diverse campus events, fostering a vibrant and connected university community.</h1>
        </div>
        <div>
          <img src='https://rpieventhub.com/assets/RPIBridgePhoto-BPzBDKR5.jpg' alt='RPI Bridge' className='rounded-lg shadow-sm w-[100rem]'/>
        </div>
      </div>
      <div className='mt-24'>
          <h1 className='text-xl font-semibold'>Feedback!</h1>
        <h1 className='text-xl'>We appreciate any feedback on your experience with our site. Please take a minute to fill out our feedback form.</h1>
        <h1 className='text-xl'>If you find any bugs or have suggestions, please submit an issue on our GitHub repository: Report a GitHub Issue.</h1>
        <h1 className='text-xl'>We'd like to extend a special thanks to Corbin, Nibroc6, for sharing his database and providing some of the events displayed on our website.</h1>
      </div>
    </div>
  );
}
